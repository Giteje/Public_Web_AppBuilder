...
function(declare, _WidgetBase, lang, array, html, on, aspect, Deferred, all, NumberTextBox,
  Select, TextBox, DateTextBox, TimeTextBox, symbolUtils, CheckBox, URLInput, simpleEditors,
  ...
  //  setting, widget
    ...
    if(editorName === 'UnsupportEditor'){
      ...
      if(param.defaultValue === undefined){
        ...
        var drawType = param.defaultValue.geometryType
        .substr('esriGeometry'.length, param.defaultValue.geometryType.length).toLowerCase();
        o.types = [drawType];
        o.showClear = true;
        if(param.symbol){
