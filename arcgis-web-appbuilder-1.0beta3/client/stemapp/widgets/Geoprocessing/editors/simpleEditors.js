...
function(declare, lang, array, html, on, Deferred, all, NumberTextBox, Select, TextBox,
  DateTextBox, TimeTextBox, CheckBox, URLInput, DrawBox, SpatialReference, LinearUnit,
  FeatureSet, FeatureLayer, Query, QueryTask, esriRequest, BaseEditor) {
  var mo = {};
