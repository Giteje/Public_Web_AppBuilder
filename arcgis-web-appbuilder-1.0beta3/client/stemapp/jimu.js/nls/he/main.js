define({
    ...
    errorMessage: "הודעה",
    errorDetail: "פרט",
    widgetPlaceholderTooltip: "כדי להגדיר זאת, עבור ל Widgets ולחץ על ממלא המקום המתאים",
    ...
    filterBuilder: {
      addAnotherExpression: "הוסף ביטוי מסנן",
      addSet: "הוסף ערכת ביטויים",
    ...
    featureLayerSource: {
      ...
      setServiceUrl: "הזן את כתובת ה-URL של שירות המאפיינים או שירות המפות.",
      selectFromOnline: "הוסף מתצוגה מקוונת",
    ...
    basicLayerChooserFromMap: {
      noLayersTip: "אין שכבת ישויות זמינה במפה."
    },
